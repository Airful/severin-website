...
function AlternatingBlock({
  ...
  const imageEl = (
    <div
      className={`relative h-[420px] md:h-[750px] overflow-hidden ${!imageLeft ? "md:order-last" : ""}`}
    >
  ...
  const contentEl = (
    <div
      className={`flex items-center py-[60px] md:py-[10px] px-6 ${
        imageLeft
          ? "md:pl-[80px] md:pr-10"
          : "md:pl-[80px] md:pr-0 md:order-first"
      }`}
    >
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="relative min-h-[90vh] overflow-hidden">
        ...
        >
          <source
            src="https://cdn.prod.website-files.com/66f4f75d1030b321fb817485%2F66fedbf5574756153b6170e5_file-transcode.mp4"
            type="video/mp4"
          />
        </video>
      </section>
            ...
            >
              ...
              >
                ...
                <p className="text-[16px] leading-[160%] text-white/80 md:text-[18px]">
                  This is not a place to fix yourself or
                  <br /> heal something that is broken.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[16px] leading-[160%] text-white/80 md:text-[18px]">
                  It is a space where nothing is required of you.
                  <br />
              ...
              >
                ...
                <p className="text-[16px] leading-[160%] text-white/80 md:text-[18px]">
                  Old emotions surface not because they are pushed,
                  <br />
                  but because there is enough safety for them to complete.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-6" style={{ maxWidth: "500px" }}>
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col gap-4 font-inter text-white/70 text-[16px] leading-[160%]">
                  <p>
                    A Dark Retreat is not something you do.
                    <br />
                    It is something you move through.
                  </p>
                  <p>
                    What determines whether it becomes overwhelming or
                    transformative.
                  </p>
                  <p>It is not willpower, but nervous system capacity.</p>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.45}>
                <div className="flex flex-col gap-4 font-inter text-[16px] leading-[160%] mt-2">
                  <p className="text-white font-medium">
                    I help people enter intensity safely and come out
                    integrated.
                  </p>
                  ...
                  <p className="text-white/70">
                    Many people are already inside a dark passage, where life
                    and identity collapse.
                  </p>
                  <p className="text-white/70">
                    Support here is not about fixing, but about slowing down so
                    reorganization can happen safely.
                  </p>
                </div>
              </FadeIn>
